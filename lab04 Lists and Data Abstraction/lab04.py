...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    # 为了方便使用distance construct a city withou a name
...
# 
'''
 nature of the abstraction barrier guarantees that changing the implementation 
 of an ADT shouldn't affect the functionality of any programs that use that ADT, 
 下列lambda, 是另一种实现，但如果ADT使用正确，则q4 q5的两个function不会受到影响
'''
